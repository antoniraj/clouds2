...
<?php
	...
	$obj = new JConfig();
 	$con = mysql_connect("localhost",$obj->user,$obj->password) or die(mysql_error());
        ...
        $sql = "SELECT * FROM $obj->dbprefix"."students WHERE (DAYOFMONTH(dob)=DAYOFMONTH(CURRENT_DATE)) and (MONTH(dob)=MONTH(CURRENT_DATE))";
	...
	$message="Dear ".$row['firstname']."..!, May your birthday and every day be filled with the warmth of sunshine, the happiness of smiles, the feeling of love and the sharing of good cheer. God Bless you. Principal.";
		//send sms
