...
$dob=$_REQUEST['dob'];
$casteandreligion=$_REQUEST['casteandreligion'];
...
$pdf->SetXY(15,$row);
$pdf->SetFont('Arial','',13);
$pdf->write(10,'6. Parent Name');
$pdf->SetXY(100,$row);
$pdf->write(10,':');
$pdf->SetXY(110,$row);
$pdf->SetFont('Arial','B',14);
$pdf->write(10,$parentname);

$row=$row+$gap;
$pdf->SetXY(15,$row);
$pdf->SetFont('Arial','',13);
$pdf->write(10,'7. Date of Birth');
$pdf->SetXY(100,$row);
$pdf->write(10,':');
$pdf->SetXY(110,$row);
$pdf->SetFont('Arial','B',14);
...
$pdf->SetXY(15,$row);
$pdf->SetFont('Arial','',13);
$pdf->write(10,'8. Caste and Religion');
$pdf->SetXY(100,$row);
$pdf->write(10,':');
$pdf->SetXY(110,$row);
$pdf->SetFont('Arial','B',14);
$pdf->write(10,$casteandreligion);
