...
<table width="100%" cellpadding="10">
		...
		<div style="float:left">
                        <img src="<?php echo $iconsDir1.'/timetableterms.png'; ?>" alt="" style="width: 44px; height: 44px;" />
		</div>
		<div style="float:left">
			<h1 class="item-page-title" align="left">Time Table Terms</h1>
		</div>
			...
			<div style="float:right;">
                        <a href="<?php echo $modulelink; ?>"><img src="<?php echo $iconsDir1.'/timetable.png'; ?>" alt="Master" style="width: 32px; height: 32px;" /></a><br />
			</div>
                </td>
        </tr>
</table>
	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						    <h2><i class="icon-edit"></i> Time Table Terms</h2>
								<div class="box-icon">
						...
						?>
							  <tr>
							   <td><input type="checkbox" name="cid[]" id="cid[]" value="<?php echo $rec->id; ?>" /> </td>
								...
								<td><?php echo JArrayHelper::indianDate($rec->startdate); ?></td>
								<td><?php echo JArrayHelper::indianDate($rec->stopdate); ?></td>
...
<input type="hidden" name="view" value="timetableterms" />
<input type="hidden" name="controller" value="timetableterms" />
