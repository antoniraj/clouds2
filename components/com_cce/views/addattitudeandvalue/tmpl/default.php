...
<div class="span6"> 
   <div class="row-fluid">
   <div class="span1">
     <img src="<?php echo $iconsDir.'/attitudeandvalues.png'; ?>" alt="Template" style="width: 48px; height: 48px;" />

   </div>
   <div class="span6">
    <h1>Add/Edit Attitude and Value</h1>
   </div>
   </div>
 </div>
...
<div class="row-fluid sortable">
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i>Add/Edit Attitude and Value</h2>
      ...
      <form action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=addacademicyear&task=save&id='.$this->rec->id.'&Itemid='.$Itemid) ?>" class="form-horizontal" method="POST"  name="addform" id="addform" onsubmit="return checkform()">
        <fieldset>
          <div class="control-group">
            <label class="control-label" for="focusedInput">Attitude/Value</label>
            <div class="controls">
	...
	<input type="hidden" id="view" name="view" value="addattitudeandvalue" />
	<input type="hidden" id="controller" name="controller" value="attitudesandvalues" />
