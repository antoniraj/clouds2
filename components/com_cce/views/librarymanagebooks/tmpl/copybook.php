...
<table width="100%" cellpadding="10">
  ...
  <div style="float:left;">
        ...
        <div style="float:left;">
                ...
                <h2></h2>
                <h2></h2>
                <h1 class="item-page-title"> Copy Book details </h1>
        </div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <strong>Copy Book details</strong></h2>
						<div class="box-icon">
					...
					<div class="box-content">
							...
							<div class="control-group success">
								<label class="control-label" for="inputSuccess">Book Number</label>
								<div class="controls">
								  <input type="text" name="bookno"  required="required" id="inputSuccess">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="focused" id="focusedInput" disabled="" type="text" required="required" name="isbn" value="<?php echo $this->rec->isbn; ?>">
								  <input type="hidden" required="required" name="isbn" value="<?php echo $this->rec->isbn; ?>">
						   ...
						   <div class="control-group">
							...
							<input type="hidden" name="layout" id="layout" value="copybook" />	
