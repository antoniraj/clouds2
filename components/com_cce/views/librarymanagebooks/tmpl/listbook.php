				...
				<div class="box span12">
					...
					foreach($this->books as $rec) {
							...
							$totalbook = $model->counttotalbooks($rec->isbn,$tbooks);
								$chold = $model->countbookshold($rec->isbn,$count);
							$available=(int)$tbooks->total-(int)$count->bookshold;
                 		?>
					  ...
					  <div style="width:100%;">
						...
						<button class="btn btn-small btn-danger"  value="Delete" name="Delete"> <i class="icon-trash"></i> Delete</button></div>
						<div style="float:right;">
							<button class="btn btn-small btn-info" name="Copy" value="Copy"><i class="icon-plus-sign"></i> Copy</button>
...
<input type="hidden" name="view" value="librarymanagebooks" />
<input type="hidden" name="controller" value="librarymanagebooks" />
<input type="hidden" name="Itemid" value="<?php echo $Itemid; ?>" />
<input type="hidden" name="task" value="actions"/>
<input type="hidden" name="layout" value="listbook"/>
</form>
