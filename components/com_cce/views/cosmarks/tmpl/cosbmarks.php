...
<?php
	echo '<center><h1>'.$crec->coursename.' - Co-Curricular Activities </h1><br><h3>['.$trec->term.']</h3></center>';
	?>
<br />
<?php
...
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<h2><i class="icon-user"></i> <?php echo $arec->activityname.'('.$arec->activitycode.')'; ?></h2>
...
<?php
		$r = $this->model->getCoSBMarks($srec->id,$activityid,$courseid,$termid,$data);		
?>			
