	...
	$this->model->getCoScholasticAActivity($activityid,$activity);
...
<?php
	echo '<center><h1>'.$crec->coursename.' - Wellness and Yoga/Holistic Exercise</h1><br><h3>['.$trec->term.']</h3></center>';
?>
<br />
<?php
...
<?php
		$r = $this->model->getCoSAMarks($srec->id,$activityid,$courseid,$termid,$data);	
?>			
