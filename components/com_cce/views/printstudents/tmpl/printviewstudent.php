...
<?php
        ...
        if( $isModal) {
                ...
                $href = '"index.php?option=com_cce&view=showstudents&controller=creports&layout=default&courseid='.$courseid.'&Itemid='.$Itemid.'&examid='.$examid.'&tmpl=component&print=1" '.$href;
        }
?>
