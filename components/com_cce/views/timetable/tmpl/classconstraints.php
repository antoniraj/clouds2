...
<div class="box">
	<div class="box-header well" data-original-title>
		<h2><i class="icon-edit"></i> <strong>Class Constraints</strong></h2>
...
<tr>
		...
		<fieldset>
			...
			foreach ($days as $day){
				...
				foreach($sessions as $ses){	
					echo '<td>';
					$rs=$model->getclassnotavailableslot($classid,$day->code,$ses->code);
					if($rs)
		...
		<input type="hidden" id="layout" name="layout" value="classconstraints" />
		<input type="hidden" name="task" id="task" value="saveclassconstraints" />
</div><!--/span-->
</form>   
