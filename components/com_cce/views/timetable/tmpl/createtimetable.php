...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce'); ?>" method="POST" name="adminForm">				
 ...
 <div class="form-actions">
       <button class="btn btn-primary" name="Go" value="Go"><i class="icon-upload icon-white"></i> Go</button>
 </div>              
        ...
        <?php
         ...
         ?>
						...
						<div class="form-actions" align="right">
								<button class="btn btn-primary" name="Allote" value="Allote"><i class="icon-plus-sign icon-white"></i> Allot</button>
						</div>
