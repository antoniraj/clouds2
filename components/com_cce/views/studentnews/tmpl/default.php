...
// No direct access
   ...
   $model =   & $this->getModel();
   $model->getSideBarStudentNews($rec);
...
<table width="100%" cellpadding="10">
  ...
  <div style="float:left;">
           <img src="<?php echo $iconsDir1.'/studentnews.png'; ?>" alt="" style="width: 64px; height: 64px;" />
        </div>
        <div style="float:left;">
                <h2></h2>
                <h1 class="item-page-title">Announcements to Students</h1>
        </div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Announcements to Students</h2>
						<div class="box-icon">
						...
						<form action="index.php" class="form-horizontal" method="POST" name="addform" id="addform" onSubmit="return stest()">
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="textarea2">Student News Text :</label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="newstext1"><?php echo $rec->newstext1; ?></textarea>
							  </div>
							</div>
       ...
       <input type="hidden" name="option" value="<?php echo JRequest::getVar('option'); ?>" />
        ...
        <input type="hidden" id="view" name="view" value="studentnews" />
        <input type="hidden" id="Itemid" name="Itemid" value="<?php echo $Itemid; ?>" />
        <input type="hidden" name="task" id="task" value="updatesidebarstudentnews" />
					</form>
