...
<div class="row-fluid">
  <div class="span6">
    <div class="row-fluid">
      <div class="span1"> <img src="<?php echo $iconsDir1.'/csba.png'; ?>" alt="Template" style="width: 48px; height: 44px;" /> </div>
      <div class="span6">
        <h1> Co-Scholastic-B Activities</h1>
      </div>
    </div>
  </div>
...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i>  Co-Scholastic-B Activities</h2>
  ...
  <!--/row-->
<input type="hidden" name="view" value="coscholasticbactivities" />
<input type="hidden" name="controller" value="coscholasticbactivities" />
