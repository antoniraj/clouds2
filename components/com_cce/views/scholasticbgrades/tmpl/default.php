...
<div class="row-fluid">
  <div class="span6">
    <div class="row-fluid">
      <div class="span1"> <img src="<?php echo $iconsDir.'/scholasticbgrades.png'; ?>" alt="Template" style="width: 48px; height: 44px;" /> </div>
      <div class="span6">
        <h1>Scholastic B-Grades</h1>
      </div>
    </div>
  </div>
...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    ...
    <div class="box-content">
      <table class="table table-striped table-bordered bootstrap-datatable datatable">
        ...
        <tbody>
          <?php
					foreach($this->scholasticbgrades as $rec) {
                 		?>
          <tr>
  ...
  <!--/row-->
<input type="hidden" name="controller" value="scholasticbgrades" />
<input type="hidden" name="view" value="scholasticbgrades" />
