<?php
	...
	$this->model->getCoScholasticBActivity($activityid,$activity);
...
<?php
	echo '<center><h1>'.$crec->code.' - Wellness and Yoga</h1><br><h3>['.$trec->term.']</h3></center>';
?>
...
<div class="row-fluid sortable">		
  ...
  <input type="hidden" name="Itemid" value="<?php echo $Itemid; ?>" />
    <input type="hidden" name="layout" value="cosbreports" />
    </fieldset>
