...
<?php
        ...
        if( $isModal) {
                ...
                $href = '"index.php?option=com_cce&view=feecollection&controller=feecollection&layout=takeprint&task=print&storedid='.$this->rec->id.'&tmpl=component&print=1" '.$href;
        }
?>
...
<table width="100%" cellpadding="0">
        ...
        <div style="float:left;">
                <div>&nbsp;</div>
                <h1 class="item-page-title">Print</h1>
        </div>
...
<div style="float:right;margin-right:300px;"><a href=<?php echo $href; ?> ><img src="<?php echo $iconsDir.'/printer.png'; ?>" alt="" style="width: 16px; height: 16px;" /></a></div>
   ...
   <div align="right" style="margin-top:10px;width:180px;float:left;" class="findtotal"><h3><span style="color:#000;">Amount = </span>  <?php  echo $this->rec->amount; ?></h3> </div>
    <div align="right" style="margin-top:10px;float:right;width:180px;" class="findtotal"><h3><span style="color:#000;">Fine =</span>  <?php echo $this->rec->fine; ?></h3></div>	
	   <div align="right" style="margin-top:20px;width:280px;float:right;" class="findtotal"><h3><span style="color:#000;">Total= </span><?php echo $this->rec->total; ?> </h3></div>	
		...
		<div style="margin:76px 0px 0px 220px;float:right;"><h4><span style="color:#000;">Principal's Signature</span></h3> </td></tr></table></div>	
