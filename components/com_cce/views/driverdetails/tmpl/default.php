...
<table width="100%" cellpadding="10">
        ...
        <div style="float:left;">
                <div>&nbsp;</div>
                <h1 class="item-page-title">Driver Details</h1>
        </div>
            ...
            <div style="float:right; width:10px;"> &nbsp;</div>
			<div style="float:right;">
                        <a href="<?php echo $settings; ?>"><img src="<?php echo $iconsDir1.'/settings.png'; ?>" alt="settings" style="width: 32px; height: 32px;" /></a><br />
			</div>
...
<br />
<form action="<?php echo JRoute::_('index.php?option=com_cce&controller=driverdetails&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">

<table width="100%" border="1" cellspacing="0" cellpadding="0">
<tr>
        <th class="list-title" style="height:20px;" width=""><input type="checkbox" onchange="checkAll()" name="chk[]" /></th>
        <th class="list-title" style="height:20px;" width="">Name</th>
        <th class="list-title" width="">DOB</th>
        <th class="list-title" width="">Address</th>
         <th class="list-title" width="">license</th>
        <th class="list-title" width="">Expiry Date</th>
...
<?php
		  echo $sno++ ."</td>";
		          echo "<td>$rec->Fname $rec->Lname</td>";
                  echo "<td>$rec->dob</td>";
				 echo "<td>$rec->address</td>";
                 echo "<td>$rec->license</td>";
				 echo "<td>$rec->Edate</td>";
...
<input type="hidden" name="controller" value="driverdetails" />
<input type="hidden" name="view" value="driverdetails" />
