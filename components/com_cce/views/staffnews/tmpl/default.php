...
<table width="100%" cellpadding="10">
  ...
  <div style="float:left;">
           <img src="<?php echo $iconsDir1.'/staffnews.png'; ?>" alt="Staff News" style="width: 64px; height: 64px;" />
        </div>
        <div style="float:left;">
                <h2></h2>
                <h1 class="item-page-title">Announcements to Staff</h1>
        </div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Announcements to Staff</h2>
						<div class="box-icon">
						...
						<form action="index.php" class="form-horizontal" method="POST" name="addform" id="addform" onSubmit="return stest()">
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="textarea2">Staff News Text :</label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="newstext2"><?php echo $rec->newstext2; ?></textarea>
							  </div>
							</div>
        ...
        <input type="hidden" id="view" name="view" value="staffnews" />
        <input type="hidden" id="Itemid" name="Itemid" value="<?php echo $Itemid; ?>" />
        <input type="hidden" name="task" id="task" value="updatesidebarstaffnews" />
					</form>
