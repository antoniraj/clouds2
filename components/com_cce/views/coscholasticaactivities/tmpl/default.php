...
<div class="row-fluid">
  <div class="span6">
    <div class="row-fluid">
      <div class="span1"> <img src="<?php echo $iconsDir1.'/csaa.png'; ?>" alt="Template" style="width: 48px; height: 44px;" /> </div>
      <div class="span6">
        <h1>  Co-Scholastic-A Activities</h1>
      </div>
    </div>
  </div>
  <div class="span6" align="right"> <a href="<?php echo $modulelink; ?>"><img src="<?php echo $iconsDir1.'/1results.png'; ?>" alt="Grades" style="width: 38px; height: 38px;" /></a> <a href="<?php echo $dashboardlink; ?>"><img src="<?php echo $iconsDir1.'/1dashboard.png'; ?>" alt="Dash Board" style="width: 38px; height: 38px;" /></a> </div>
</div>
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i>  Co-Scholastic-A Activities</h2>
  ...
  <!--/row-->
<input type="hidden" name="view" value="coscholasticaactivities" />
<input type="hidden" name="controller" value="coscholasticaactivities" />
