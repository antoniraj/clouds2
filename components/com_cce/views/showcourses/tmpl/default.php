...
<table width="100%" cellpadding="10">
  ...
  <div style="float:left;">
        ...
        <div style="float:left;">
                ...
                <h2></h2>
                <h2></h2>
                <h1 class="item-page-title">Enter Marks</h1>
        </div>
	...
	<div class="row-fluid sortable">
		...
		$rc=1;
			...
			if($rec->assessmenttype=='CCE')
				$link = JRoute::_('index.php?option='.JRequest::getVar('option').'&controller=courses&view=showcourseprofile&courseid='.$rec->id.'&Itemid='.$Itemid);
			else
				$link = JRoute::_('index.php?option='.JRequest::getVar('option').'&controller=courses&view=showcourseprofilenormal&courseid='.$rec->id.'&Itemid='.$Itemid);
           		?> <!--<img src="<?php echo $iconsDir1.'/'.$rec->filename; ?>" alt="" style="width: 64px; height: 64px;" /> --> <?php
