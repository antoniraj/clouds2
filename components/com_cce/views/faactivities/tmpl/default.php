...
<div class="span6"> 
   <div class="row-fluid">
   <div class="span1">
     <img src="<?php echo $iconsDir.'/faactivities.png'; ?>" alt="Template" style="width: 68px; height: 48px;" />

   </div>
   <div class="span6">
    <h1>Formative Assessment Activities</h1>
   </div>
   </div>
 </div>
...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i> Formative Assessment Activities</h2>
...
<input type="hidden" name="view" value="faactivities" />
<input type="hidden" name="controller" value="faactivities" />
