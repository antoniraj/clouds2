...
//	setlocale(LC_ALL, "en_US.UTF-8");
	...
	$execllink = JRoute::_('index.php?option='.JRequest::getVar('option').'&view=fees&task=display&layout=excel-pendingpayment&controller=fees&tmpl=component&accountid='.$accountid.'&Itemid='.$Itemid.'&fcid='.$fcid.'&fstid='.$fstid);
?>

<b style="font: bold 15px Georgia, serif;">REPORT ON ACTUAL FEE COLLECTION</b>
...
?>
<td style="text-align:right;font: bold 15px verdana, serif;font-family:Arial;"> <b> <?php echo '&#8377;&nbsp;'.$model->formatInIndianStyle($s_tot_con); ?> </b></td>
