...
<br />
<form action="<?php echo JRoute::_('index.php?option=com_cce&controller=sms&courseid='.$this->courseid.'&view=sms&task=displaystudents&layout=batchstudentsms'); ?>" method="POST" name="adminForm">
