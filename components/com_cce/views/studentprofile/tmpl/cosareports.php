...
<?php
	   ...
	   foreach($arecs as $arec){
		$link = JRoute::_('index.php?option='.JRequest::getVar('option').'&controller=cosreports&view=cosreports&layout=cosareports&termid='.$termid.'&activityid='.$arec->id.'&courseid='.$courseid.'&Itemid='.$Itemid);
