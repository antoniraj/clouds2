...
<?php
   ...
   $pdflink= JRoute::_('index.php?option='.JRequest::getVar('option').'&controller=studentprofile&view=studentprofile&layout=pdfprofile&regno='.$stu_rec->registerno.'&id='.$stu_rec->id.'&Itemid='.$masterItemid.'&format=pdf&tmpl=component');
	...
	$pathway->addItem('Attendance Certificate');
	...
	$pdf3=JURI::Base()."components/com_cce/fpdf/attendance.php";
...
<p> </p>
<br />
	<b><p style="font-size:150%">ATTENDANCE CERTIFICATE</p></b>
<br />
<table border="0" width="100%">
	...
	<tr>
		<td width="2%"> 6. </td>
		<td width="48%"> Working Days</td>
		<td width="2%"> :</td>
		<td width="48%">
			<p style="font-size:130%" ><input type="text" name="workingdays" class="ss" style="width:300px;" value="<?php echo $workingdays; ?>" /> 
		</td>
	</tr>
	<tr>
		<td width="2%"> 7. </td>
		<td width="48%"> Number of days present</td>
		<td width="2%"> :</td>
		<td width="48%">
			<p style="font-size:130%" ><input type="text" name="present" class="ss" style="width:300px;" value="<?php echo $present; ?>" /> 
		</td>
	</tr>
	<tr>
		<td width="2%"> 8. </td>
		<td width="48%"> Attendance Percentage(%)</td>
		<td width="2%"> :</td>
		<td width="48%">
			<p style="font-size:130%" ><input type="text" name="percent" class="ss" style="width:300px;" value="<?php echo $percent; ?>" /> 
		</td>
	</tr>
</table>
</td>
