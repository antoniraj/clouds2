...
<table width="100%" cellpadding="10">
  ...
  <div style="float:left;">
           <img src="<?php echo $library1.'/renewbook.png'; ?>" alt="" style="width: 64px; height: 64px;" />
        </div>
        <div style="float:left;">
                <h2></h2>
                <h2></h2>
                <h2></h2>
                <h1 class="item-page-title"> Books Renewal </h1>
        </div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <strong>Renew Book</strong></h2>
						<div class="box-icon">
					...
					<div class="box-content">
							...
							<input type="hidden" name="layout" id="layout" value="renewbook" />	
					...
					<div class="box-content">
							<fieldset>
		 				    ...
		 				    <div class="control-group">
								...
								<div class="controls">
								  <input class="disabled" id="focusedInput" disabled="" type="text" value="<?php echo $this->book->edition; ?>">
								</div>
							  </div>
							    <div class="control-group">
								<label class="control-label" for="focusedInput">Publisher</label>
								<div class="controls">
								  <input class="disabled" id="focusedInput" disabled="" type="text" value="<?php echo $this->book->publisher; ?>">
								</div>
							  </div>
					...
					<div class="box-content">
							<fieldset>
				             ...
				             <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="datepicker" disabled="" id="date01" required="required" value="<?php echo JArrayHelper::indianDate1($this->issue->issuedate); ?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date02">Due Date</label>
							  <div class="controls">
								<input type="text" class="datepicker" disabled=""  id="date02" required="required"  value="<?php echo JArrayHelper::indianDate1($this->issue->duedate); ?>">
							  </div>
							</div>
							  
							   <div class="control-group">
							  <label class="control-label" for="date04">Renewal Date</label>
							  <div class="controls">
								<input type="text" class="datepicker" name="renewaldate" id="date04" required="required" value="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date05">Due Date</label>
							  <div class="controls">
								<input type="text" class="datepicker" name="duedate" id="date05" required="required"  value="">
							  </div>
							</div>
							  <?php } ?>
							</fieldset>
				...
				<div class="form-actions">
					<div class="span12" align="right">
							  <button type="submit" name="save" value="save" class="btn btn-primary">Renew Book</button>
							...
							<input type="hidden" id="issuedid" name="issuedid" value="<?php echo $this->issue->id; ?>" />
