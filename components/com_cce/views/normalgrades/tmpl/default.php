...
<div class="span6"> 
   <div class="row-fluid">
   <div class="span2">
     <img src="<?php echo $iconsDir.'/normalgrades.png'; ?>" alt="Template" style="width: 68px; height: 68px;" />
...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i> Grades</h2>
    ...
    <div class="box-content">
      <table class="table table-striped table-bordered bootstrap-datatable datatable">
        ...
        <tbody>
          <?php
					foreach($this->normalgrades as $rec) {
                 		?>
          <tr>
  ...
  <!--/row-->
    <input type="hidden" name="controller" value="normalgrades" />
    <input type="hidden" name="view" value="normalgrades" />
