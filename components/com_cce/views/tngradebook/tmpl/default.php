...
<form class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_cce&controller=academicyears&view=academicyears&task=actions&Itemid='.$Itemid); ?>" method="POST" name="adminForm">
  ...
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i> Examinations</h2>
    ...
    <div class="box-content">
      <table class="table table-striped table-bordered bootstrap-datatable datatable">
        ...
        <tbody>
          <?php
					foreach($this->tngradebook as $rec) {
                 		?>
          <tr>
            ...
            <td><?php echo JArrayHelper::indianDate($rec->duedate); ?></td>
  ...
  <input type="hidden" name="controller" value="tngradebook" />
  <input type="hidden" name="view" value="tngradebook" />
