...
<div class="span6"> 
   <div class="row-fluid">
   <div class="span1">
     <img src="<?php echo $iconsDir.'/csba.png'; ?>" alt="Template" style="width: 48px; height: 48px;" />

   </div>
   <div class="span6">
    <h1>Add/Edit CoScholastic-B Activity</h1>
   </div>
   </div>
 </div>
...
<div class="row-fluid sortable">
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-edit"></i>Add/Edit CoScholastic - B Activity</h2>
	...
	<input type="hidden" id="view" name="view" value="addcoscholasticbactivity" />
	<input type="hidden" id="controller" name="controller" value="coscholasticbactivities" />
