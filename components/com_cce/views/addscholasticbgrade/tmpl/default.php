...
<div class="span6"> 
   <div class="row-fluid">
   <div class="span1">
     <img src="<?php echo $iconsDir1.'/scholasticbgrades.png'; ?>" alt="Template" style="width: 48px; height: 48px;" />
...
<div class="row-fluid sortable">
  <div class="box span12">
	...
	<input type="hidden" id="controller" name="controller" value="scholasticbgrades" />
	<input type="hidden" id="view" name="view" value="addscholasticbgrade" />
